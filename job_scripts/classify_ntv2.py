...
# Load the data
if args.pooling == "cls":
    train_data = pd.read_csv(f"{args.data_path}/results/train_embed_ntv2.csv")
    test_data = pd.read_csv(f"{args.data_path}/results/test_embed_ntv2.csv")
else:
    train_data = pd.read_csv(f"{args.data_path}/results/train_embed_ntv2_meanpool.csv")
    test_data = pd.read_csv(f"{args.data_path}/results/test_embed_ntv2_meanpool.csv")
...
if args.pooling == "cls":
    results_df.to_csv(f"/rsrch4/home/biostatistics/hfeng3/review_datasets/results_final/ntv2/{args.data_name}.csv",
                      index=False)
    if args.multiclass == "no":
        ...
        preds_table.to_csv(f"/rsrch4/home/biostatistics/hfeng3/review_datasets/preds/ntv2/{args.data_name}.csv",
                       index=False)
else:
    results_df.to_csv(f"/rsrch4/home/biostatistics/hfeng3/review_datasets/results_final/ntv2_meanpool/{args.data_name}.csv",
                      index=False)
    if args.multiclass == "no":
        preds_table = pd.DataFrame({
        'True': y_test,
        ...
        preds_table.to_csv(f"/rsrch4/home/biostatistics/hfeng3/review_datasets/preds/ntv2_meanpool/{args.data_name}.csv",
                       index=False)
