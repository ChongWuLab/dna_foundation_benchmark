...
# Define sequence lengths as powers of 2
seq_lengths = [2**i for i in range(5, 20)]  # 65536, 131072, 262144, 524288, 1048576
results = {}

# Run experiments for each sequence length
for seq_length in seq_lengths:
    # Set max_length to one quarter of seq_length
    ...
    for i in range(n_repetitions):
        ...
        # If error occurred, exit the repetition loop for this sequence length
        if runtime is None:
...
output_path = "../runtimes/hyena_long.csv"
