...
# Load the data
if args.pooling == "cls":
    train_data = pd.read_csv(f"{project_dir}/embeddings/{args.data_name}/train_embed_dnabert.csv")
    test_data = pd.read_csv(f"{project_dir}/embeddings/{args.data_name}/test_embed_dnabert.csv")
elif args.pooling == "mean":
    train_data = pd.read_csv(f"{project_dir}/embeddings/{args.data_name}/train_embed_dnabert_meanpool.csv")
    test_data = pd.read_csv(f"{project_dir}/embeddings/{args.data_name}/test_embed_dnabert_meanpool.csv")
else:
    train_data = pd.read_csv(f"{project_dir}/embeddings/{args.data_name}/train_embed_dnabert_maxpool.csv")
    test_data = pd.read_csv(f"{project_dir}/embeddings/{args.data_name}/test_embed_dnabert_maxpool.csv")
...
if args.pooling == "cls":
    os.makedirs(f"{project_dir}/results_final/dnabert2", exist_ok=True)
    os.makedirs(f"{project_dir}/preds/dnabert2", exist_ok=True)
    results_df.to_csv(f"{project_dir}/results_final/dnabert2/{args.data_name}_{args.classifier}.csv",
                    index=False)
    if args.multiclass == "no":
        ...
        preds_table.to_csv(f"{project_dir}/preds/dnabert2/{args.data_name}_{args.classifier}.csv",
                    index=False)
        
elif args.pooling == "mean":
    os.makedirs(f"{project_dir}/results_final/dnabert2_meanpool", exist_ok=True)
    os.makedirs(f"{project_dir}/preds/dnabert2_meanpool", exist_ok=True)
    results_df.to_csv(f"{project_dir}/results_final/dnabert2_meanpool/{args.data_name}_{args.classifier}.csv",
                    index=False)
    if args.multiclass == "no":
        preds_table = pd.DataFrame({
        'True': y_test,
        ...
        preds_table.to_csv(f"{project_dir}/preds/dnabert2_meanpool/{args.data_name}_{args.classifier}.csv",
                    index=False)

else:
    os.makedirs(f"{project_dir}/results_final/dnabert2_maxpool", exist_ok=True)
    os.makedirs(f"{project_dir}/preds/dnabert2_maxpool", exist_ok=True)
    results_df.to_csv(f"{project_dir}/results_final/dnabert2_maxpool/{args.data_name}_{args.classifier}.csv",
                    index=False)
    if args.multiclass == "no":
        preds_table = pd.DataFrame({
        'True': y_test,
        ...
        preds_table.to_csv(f"{project_dir}/preds/dnabert2_maxpool/{args.data_name}_{args.classifier}.csv",
                    index=False)
