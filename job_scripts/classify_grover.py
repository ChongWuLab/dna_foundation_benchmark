...
# Load the data
if args.pooling == "cls":
    train_data = pd.read_csv(f"{project_dir}/embeddings/{args.data_name}/train_embed_grover.csv")
    test_data = pd.read_csv(f"{project_dir}/embeddings/{args.data_name}/test_embed_grover.csv")
elif args.pooling == "mean":
    train_data = pd.read_csv(f"{project_dir}/embeddings/{args.data_name}/train_embed_grover_meanpool.csv")
    test_data = pd.read_csv(f"{project_dir}/embeddings/{args.data_name}/test_embed_grover_meanpool.csv")
else:
    train_data = pd.read_csv(f"{project_dir}/embeddings/{args.data_name}/train_embed_grover_maxpool.csv")
    test_data = pd.read_csv(f"{project_dir}/embeddings/{args.data_name}/test_embed_grover_maxpool.csv")
...
if args.pooling == "cls":
    os.makedirs(f"{project_dir}/results_final/grover", exist_ok=True)
    os.makedirs(f"{project_dir}/preds/grover", exist_ok=True)
    results_df.to_csv(f"{project_dir}/results_final/grover/{args.data_name}_{args.classifier}.csv",
                    index=False)
    if args.multiclass == "no":
        ...
        preds_table.to_csv(f"{project_dir}/preds/grover/{args.data_name}_{args.classifier}.csv",
                    index=False)
        
elif args.pooling == "mean":
    os.makedirs(f"{project_dir}/results_final/grover_meanpool", exist_ok=True)
    os.makedirs(f"{project_dir}/preds/grover_meanpool", exist_ok=True)
    results_df.to_csv(f"{project_dir}/results_final/grover_meanpool/{args.data_name}_{args.classifier}.csv",
                    index=False)
    if args.multiclass == "no":
        preds_table = pd.DataFrame({
        'True': y_test,
        ...
        preds_table.to_csv(f"{project_dir}/preds/grover_meanpool/{args.data_name}_{args.classifier}.csv",
                    index=False)
        
else:
    os.makedirs(f"{project_dir}/results_final/grover_maxpool", exist_ok=True)
    os.makedirs(f"{project_dir}/preds/grover_maxpool", exist_ok=True)
    results_df.to_csv(f"{project_dir}/results_final/grover_maxpool/{args.data_name}_{args.classifier}.csv",
                    index=False)
    if args.multiclass == "no":
        preds_table = pd.DataFrame({
        'True': y_test,
        ...
        preds_table.to_csv(f"{project_dir}/preds/grover_maxpool/{args.data_name}_{args.classifier}.csv",
                    index=False)
