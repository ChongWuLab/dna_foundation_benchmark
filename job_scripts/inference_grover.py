...
if args.pooling == "cls":
    output.to_csv(f'{project_dir}/embeddings/{args.data_name}/train_embed_grover.csv', index=False)
elif args.pooling == "mean":
    output.to_csv(f'{project_dir}/embeddings/{args.data_name}/train_embed_grover_meanpool.csv', index=False)
else:
    output.to_csv(f'{project_dir}/embeddings/{args.data_name}/train_embed_grover_maxpool.csv', index=False)
...
output.columns = [f"embedding_{i}" for i in range(768)] + ["target"]
if args.pooling == "cls":
    output.to_csv(f'{project_dir}/embeddings/{args.data_name}/test_embed_grover.csv', index=False)
elif args.pooling == "mean":
    output.to_csv(f'{project_dir}/embeddings/{args.data_name}/test_embed_grover_meanpool.csv', index=False)
else:
    output.to_csv(f'{project_dir}/embeddings/{args.data_name}/test_embed_grover_maxpool.csv', index=False)