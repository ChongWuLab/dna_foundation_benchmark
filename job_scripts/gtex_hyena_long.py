...
max_length = 196609  # The maximum length after tokenization. For HyenaDNA, this is seq_length + 1.
batch_size = 8
seq_length = 196608  # The sequence length used in this experiment
files_per_job = 10  # Number of files to process per job
...
# Check if job_index is too large (maximum should be 2 for 50 files)
max_job_index = (total_files + files_per_job - 1) // files_per_job  # Ceiling division
...
output_csv = f"{output_dir}embed_hyena_long_{start_file}_to_{end_file}.csv"
