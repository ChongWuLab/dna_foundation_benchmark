...
MAX_TOKENIZER_LENGTH = INPUT_SEQUENCE_LENGTH + 1
BATCH_SIZE = 8
...
def _embed_batch(seq_list, tokenizer, model, max_length):
...
def get_hyena_embeddings(model, tokenizer, sequences, batch_size, max_length):
    ...
    for i in range(0, num_sequences, batch_size):
        ...
        batch_embeddings = _embed_batch(batch_seqs, tokenizer, model, max_length)
...
for folder in folders:
    for file_type in file_types:
        ...
        embeddings1 = get_hyena_embeddings(model, tokenizer, sequences1, BATCH_SIZE, MAX_TOKENIZER_LENGTH)

        print(f"Generating embeddings for {num_seqs} sequences in Seq2...")
        embeddings2 = get_hyena_embeddings(model, tokenizer, sequences2, BATCH_SIZE, MAX_TOKENIZER_LENGTH)
