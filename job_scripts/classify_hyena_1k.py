...
# Load the data
if args.pooling == "eos":
    train_data = pd.read_csv(f"{project_dir}/embeddings/{args.data_name}/train_embed_hyena_1k.csv")
    test_data = pd.read_csv(f"{project_dir}/embeddings/{args.data_name}/test_embed_hyena_1k.csv")
elif args.pooling == "mean":
    train_data = pd.read_csv(f"{project_dir}/embeddings/{args.data_name}/train_embed_hyena_1k_meanpool.csv")
    test_data = pd.read_csv(f"{project_dir}/embeddings/{args.data_name}/test_embed_hyena_1k_meanpool.csv")
else:
    train_data = pd.read_csv(f"{project_dir}/embeddings/{args.data_name}/train_embed_hyena_1k_maxpool.csv")
    test_data = pd.read_csv(f"{project_dir}/embeddings/{args.data_name}/test_embed_hyena_1k_maxpool.csv")
...
if args.pooling == "eos":
    os.makedirs(f"{project_dir}/results_final/hyena_1k", exist_ok=True)
    os.makedirs(f"{project_dir}/preds/hyena_1k", exist_ok=True)
    results_df.to_csv(f"{project_dir}/results_final/hyena_1k/{args.data_name}_{args.classifier}.csv",
                      index=False)
    if args.multiclass == "no":
        ...
        preds_table.to_csv(f"{project_dir}/preds/hyena_1k/{args.data_name}_{args.classifier}.csv",
                       index=False)

elif args.pooling == "mean":
    os.makedirs(f"{project_dir}/results_final/hyena_1k_meanpool", exist_ok=True)
    os.makedirs(f"{project_dir}/preds/hyena_1k_meanpool", exist_ok=True)
    results_df.to_csv(f"{project_dir}/results_final/hyena_1k_meanpool/{args.data_name}_{args.classifier}.csv",
                      index=False)
    if args.multiclass == "no":
        preds_table = pd.DataFrame({
        'True': y_test,
        ...
        preds_table.to_csv(f"{project_dir}/preds/hyena_1k_meanpool/{args.data_name}_{args.classifier}.csv",
                       index=False)

else:
    os.makedirs(f"{project_dir}/results_final/hyena_1k_maxpool", exist_ok=True)
    os.makedirs(f"{project_dir}/preds/hyena_1k_maxpool", exist_ok=True)
    results_df.to_csv(f"{project_dir}/results_final/hyena_1k_maxpool/{args.data_name}_{args.classifier}.csv",
                      index=False)
    if args.multiclass == "no":
        preds_table = pd.DataFrame({
        'True': y_test,
        ...
        preds_table.to_csv(f"{project_dir}/preds/hyena_1k_maxpool/{args.data_name}_{args.classifier}.csv",
                       index=False)
