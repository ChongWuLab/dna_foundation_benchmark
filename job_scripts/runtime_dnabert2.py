...
# Define sequence lengths as powers of 4
seq_lengths = [2**i for i in range(5, 13)]  # 32, 64, 128, 256, 512, 1024, ..., 524288
results = {}

# Run experiments for each sequence length
for seq_length in seq_lengths:
    # Set max_length to one quarter of seq_length
    max_length = max(1, seq_length // 4)
...
output_path = "../runtimes/dnabert2.csv"
