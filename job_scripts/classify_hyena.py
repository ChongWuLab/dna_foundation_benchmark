...
# Load the data
if args.pooling == "eos":
    train_data = pd.read_csv(f"{project_dir}/embeddings/{args.data_name}/train_embed_hyena.csv")
    test_data = pd.read_csv(f"{project_dir}/embeddings/{args.data_name}/test_embed_hyena.csv")
elif args.pooling == "mean":
    train_data = pd.read_csv(f"{project_dir}/embeddings/{args.data_name}/train_embed_hyena_meanpool.csv")
    test_data = pd.read_csv(f"{project_dir}/embeddings/{args.data_name}/test_embed_hyena_meanpool.csv")
else:
    train_data = pd.read_csv(f"{project_dir}/embeddings/{args.data_name}/train_embed_hyena_maxpool.csv")
    test_data = pd.read_csv(f"{project_dir}/embeddings/{args.data_name}/test_embed_hyena_maxpool.csv")
...
if args.pooling == "eos":
    os.makedirs(f"{project_dir}/results_final/hyena", exist_ok=True)
    os.makedirs(f"{project_dir}/preds/hyena", exist_ok=True)
    results_df.to_csv(f"{project_dir}/results_final/hyena/{args.data_name}_{args.classifier}.csv",
                      index=False)
    if args.multiclass == "no":
        ...
        preds_table.to_csv(f"{project_dir}/preds/hyena/{args.data_name}_{args.classifier}.csv",
                       index=False)

elif args.pooling == "mean":
    os.makedirs(f"{project_dir}/results_final/hyena_meanpool", exist_ok=True)
    os.makedirs(f"{project_dir}/preds/hyena_meanpool", exist_ok=True)
    results_df.to_csv(f"{project_dir}/results_final/hyena_meanpool/{args.data_name}_{args.classifier}.csv",
                      index=False)
    if args.multiclass == "no":
        preds_table = pd.DataFrame({
        'True': y_test,
        ...
        preds_table.to_csv(f"{project_dir}/preds/hyena_meanpool/{args.data_name}_{args.classifier}.csv",
                       index=False)

else:
    os.makedirs(f"{project_dir}/results_final/hyena_maxpool", exist_ok=True)
    os.makedirs(f"{project_dir}/preds/hyena_maxpool", exist_ok=True)
    results_df.to_csv(f"{project_dir}/results_final/hyena_maxpool/{args.data_name}_{args.classifier}.csv",
                      index=False)
    if args.multiclass == "no":
        preds_table = pd.DataFrame({
        'True': y_test,
        ...
        preds_table.to_csv(f"{project_dir}/preds/hyena_maxpool/{args.data_name}_{args.classifier}.csv",
                       index=False)
