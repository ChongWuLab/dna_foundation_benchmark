...
# Load the data
if args.pooling == "eos":
    train_data = pd.read_csv(f"{args.data_path}/results/train_embed_hyena.csv")
    test_data = pd.read_csv(f"{args.data_path}/results/test_embed_hyena.csv")
else:
    train_data = pd.read_csv(f"{args.data_path}/results/train_embed_hyena_meanpool.csv")
    test_data = pd.read_csv(f"{args.data_path}/results/test_embed_hyena_meanpool.csv")
...
if args.pooling == "eos":
    results_df.to_csv(f"/rsrch4/home/biostatistics/hfeng3/review_datasets/results_final/hyena/{args.data_name}.csv",
                      index=False)
    if args.multiclass == "no":
        ...
        preds_table.to_csv(f"/rsrch4/home/biostatistics/hfeng3/review_datasets/preds/hyena/{args.data_name}.csv",
                       index=False)
else:
    results_df.to_csv(f"/rsrch4/home/biostatistics/hfeng3/review_datasets/results_final/hyena_meanpool/{args.data_name}.csv",
                      index=False)
    if args.multiclass == "no":
        preds_table = pd.DataFrame({
        'True': y_test,
        ...
        preds_table.to_csv(f"/rsrch4/home/biostatistics/hfeng3/review_datasets/preds/hyena_meanpool/{args.data_name}.csv",
                       index=False)
