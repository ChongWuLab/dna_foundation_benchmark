...
if args.pooling == "eos":
    output.to_csv(f'{project_dir}/embeddings/{args.data_name}/train_embed_hyena_1k.csv', index=False)
elif args.pooling == "mean":
    output.to_csv(f'{project_dir}/embeddings/{args.data_name}/train_embed_hyena_1k_meanpool.csv', index=False)
else:
    output.to_csv(f'{project_dir}/embeddings/{args.data_name}/train_embed_hyena_1k_maxpool.csv', index=False)
...
output.columns = [f"embedding_{i}" for i in range(256)] + ["target"]
if args.pooling == "eos":
    output.to_csv(f'{project_dir}/embeddings/{args.data_name}/test_embed_hyena_1k.csv', index=False)
elif args.pooling == "mean":
    output.to_csv(f'{project_dir}/embeddings/{args.data_name}/test_embed_hyena_1k_meanpool.csv', index=False)
else:
    output.to_csv(f'{project_dir}/embeddings/{args.data_name}/test_embed_hyena_1k_maxpool.csv', index=False)